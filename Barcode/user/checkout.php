        ...
        <div class="col-lg-6 px-4 pb-4" id="order">
            ...
            <form action="" method="post" id="placeOrder">
                ...
                <div class="form-group">
                    <input type="text" value="<?= $_SESSION['alamat']; ?>" class="form-control" placeholder="Name" required name="name" id="">
                </div>
                <div class="form-group">
                    <input type="email" class="form-control" placeholder="Email" required name="email" id="">
                </div>
                <div class="form-group">
                    <input type="tel" name="phone" value="<?= $_SESSION['level']; ?>" class="form-control" placeholder="Nomor Telepon" required  id="">
                </div>
                <div class="form-group">
