    ...
    <div class="container mt-5">
        <div class="row">
            <!-- <div class="col-md-4 mb-5">
                <div class="card pb-2">
                    <img src="<?= $base_url ?>admin/upload/<?= $produk['gambar'] ?>" class="card-img-top p-2" alt="...">
                    <div class="card-body">
            ...
            <?php foreach ($dataproduk as $produk) : ?>
                <div class="col-md-4">
                    <div class="card pb-2">
                <!-- <img class="card-img-top img"  src="<?= $base_url ?>admin/upload/<?= $produk['gambar'] ?>"  height="300px" width="300px"> -->
